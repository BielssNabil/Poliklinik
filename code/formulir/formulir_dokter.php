...
<form action="code/proses/input/input_dokter.php" method="POST">
    ...
    <tr>
        <td><b>Jadwal Praktek</b></td>
    </tr>

    <tr>
        <td><input type="text" name="JadwalPraktek" size="25px" maxlength="30" placeholder="JadwalPraktek.." required></td>
    </tr>
    ...
    <tr>
        <td><input type="text" name="TeleponDokter" size="25px" maxlength="13" placeholder="ketikkan nomor telepon.." required> &nbsp;&nbsp;&nbsp; <input class="button" type="submit" value="Simpan"></td>
    </tr>
