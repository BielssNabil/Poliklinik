...
$updateDokter = "UPDATE dokter set KodeDokter='$KodeDokter' , NamaDokter='$NamaDokter', Spesialis='$Spesialis' , AlamatDokter='$AlamatDokter' , TeleponDokter='$TeleponDokter' where KodeDokter='$KodeDokter'";
